          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed">
                The most effective influence preserves the illusion of choice while eliminating actual options. When people believe they&apos;re deciding freely, resistance disappears. We become the invisible architect of &ldquo;voluntary&rdquo; decisions.
              </p>
            </div>
